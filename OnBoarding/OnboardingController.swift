...
class OnboardingViewController: UIViewController, UIScrollViewDelegate {
    ...
    func createSlides() -> [Slide] {
        ...
        slide1.labelTitle.text = "Welcome to Akademos"
        slide1.labelDesc.text = "When is the last time you fill your Learning journey and Reflection? \n \n There is no better time than now to do it!"
        ...
        slide3.labelTitle.text = "Hi my name is "
        slide3.labelDesc.text = "We will help you to remember stuffs needed for Apple Developer Academy Participant. But before you continue, please enter your name below."
